...
export default function Videos() {
  return (
    <>
      <PageMeta
        title="React.js Videos Tabs | CesdeAcademic - React.js Admin Dashboard Template"
        description="This is React.js Videos page for CesdeAcademic - React.js Tailwind CSS Admin Dashboard Template"
      />
