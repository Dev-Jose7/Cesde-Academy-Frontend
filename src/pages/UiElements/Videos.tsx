...
export default function Videos() {
  return (
    <>
      <PageMeta
        title="React.js Videos Tabs | CesdeAcademy - React.js Admin Dashboard Template"
        description="This is React.js Videos page for CesdeAcademy - React.js Tailwind CSS Admin Dashboard Template"
      />
