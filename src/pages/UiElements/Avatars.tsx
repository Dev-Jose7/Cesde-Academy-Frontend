...
export default function Avatars() {
  return (
    <>
      <PageMeta
        title="React.js Avatars Dashboard | CesdeAcademy - React.js Admin Dashboard Template"
        description="This is React.js Avatars Dashboard page for CesdeAcademy - React.js Tailwind CSS Admin Dashboard Template"
      />
