...
export default function Avatars() {
  return (
    <>
      <PageMeta
        title="React.js Avatars Dashboard | CesdeAcademic - React.js Admin Dashboard Template"
        description="This is React.js Avatars Dashboard page for CesdeAcademic - React.js Tailwind CSS Admin Dashboard Template"
      />
